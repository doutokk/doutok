...
func (x *UploadFileReq) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_file_proto_rawDesc = []byte{
	...
	0x93, 0x02, 0x11, 0x22, 0x0c, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x2f, 0x75, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x3a, 0x01, 0x2a, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_file_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FrontendUploadFileReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FrontendUploadFileResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type FileService interface {
	...
	FrontendUploadFile(ctx context.Context, req *FrontendUploadFileReq) (res *FrontendUploadFileResp, err error)
}
