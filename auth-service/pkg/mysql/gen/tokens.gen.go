...
func newToken(db *gorm.DB, opts ...gen.DOOption) token {
	...
	_token.Value = field.NewString(tableName, "value")
	_token.ExpirationTime = field.NewInt64(tableName, "expiration_time")
...
func (t *token) updateTableName(table string) *token {
	...
	t.ExpirationTime = field.NewInt64(table, "expiration_time")
...
func (t *token) fillFieldMap() {
	...
	t.fieldMap["expiration_time"] = t.ExpirationTime
