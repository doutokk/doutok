...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.StreetAddress = field.NewString(tableName, "street_address")
	_order.City = field.NewString(tableName, "city")
...
func (o *order) updateTableName(table string) *order {
	...
	o.StreetAddress = field.NewString(table, "street_address")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["street_address"] = o.StreetAddress
...
func (o orderDo) GetByUserId(userId uint32) (result []*model.Order, err error) {
	...
	generateSQL.WriteString("SELECT * FROM orders WHERE user_id = ? AND deleted_at is null ")
