...
type IFileDo interface {
	...
	GetByUserId(userId uint32) (result []*model.File, err error)
}

// GetByUserId get user by user id
//
// SELECT * FROM @@table WHERE user_id = @userId and deleted_at is null
func (f fileDo) GetByUserId(userId uint32) (result []*model.File, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, userId)
	generateSQL.WriteString("SELECT * FROM files WHERE user_id = ? and deleted_at is null ")
