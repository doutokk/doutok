...
const (
	...
	CartService_FrontendGetCart_FullMethodName = "/cart.CartService/FrontendGetCart"
)
...
type CartServiceClient interface {
	...
	EditCart(ctx context.Context, in *EditCartReq, opts ...grpc.CallOption) (*EditCartResp, error)
	FrontendGetCart(ctx context.Context, in *FrontendGetCartReq, opts ...grpc.CallOption) (*FrontendGetCartResp, error)
}
...
func (c *cartServiceClient) EditCart(ctx context.Context, in *EditCartReq, opts ...grpc.CallOption) (*EditCartResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EditCartResp)
...
func (c *cartServiceClient) FrontendGetCart(ctx context.Context, in *FrontendGetCartReq, opts ...grpc.CallOption) (*FrontendGetCartResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FrontendGetCartResp)
	err := c.cc.Invoke(ctx, CartService_FrontendGetCart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	EditCart(context.Context, *EditCartReq) (*EditCartResp, error)
	FrontendGetCart(context.Context, *FrontendGetCartReq) (*FrontendGetCartResp, error)
...
func (UnimplementedCartServiceServer) EditCart(context.Context, *EditCartReq) (*EditCartResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EditCart not implemented")
}
func (UnimplementedCartServiceServer) FrontendGetCart(context.Context, *FrontendGetCartReq) (*FrontendGetCartResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FrontendGetCart not implemented")
}
...
func _CartService_EditCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).EditCart(ctx, req.(*EditCartReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _CartService_FrontendGetCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FrontendGetCartReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).FrontendGetCart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_FrontendGetCart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).FrontendGetCart(ctx, req.(*FrontendGetCartReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FrontendGetCart",
			Handler:    _CartService_FrontendGetCart_Handler,
		},
	},
