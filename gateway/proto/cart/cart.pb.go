...
var file_cart_proto_rawDesc = string([]byte{
	...
	0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xeb, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x53,
	...
	0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x43,
	...
	0x12, 0x05, 0x2f, 0x63, 0x61, 0x72, 0x74, 0x12, 0x36, 0x0a, 0x09, 0x45, 0x6d, 0x70, 0x74, 0x79,
	...
	0x33, 0x0a, 0x08, 0x65, 0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x74, 0x12, 0x11, 0x2e, 0x63, 0x61,
	...
	0x73, 0x70, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x63, 0x61, 0x72, 0x74, 0x62, 0x06, 0x70,
...
var file_cart_proto_goTypes = []any{
	(*EditCartReq)(nil),   // 0: cart.editCartReq
	(*EditCartResp)(nil),  // 1: cart.editCartResp
...
var file_cart_proto_depIdxs = []int32{
	2, // 0: cart.editCartReq.items:type_name -> cart.CartItem
	2, // 1: cart.AddItemReq.item:type_name -> cart.CartItem
	8, // 2: cart.GetCartResp.cart:type_name -> cart.Cart
	2, // 3: cart.Cart.items:type_name -> cart.CartItem
	...
	0, // 7: cart.CartService.editCart:input_type -> cart.editCartReq
	...
	1, // 11: cart.CartService.editCart:output_type -> cart.editCartResp
